...
void CInstallAttack::SetOwnerImage()
{
	if (m_Owner != nullptr)
	{
		...
		{
			CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Skill/혜진/Skill_FireCircle.gif", L"InstallAttack_Monster");
		...
		{
			CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Skill/혜진/Skill_BlueCircle.gif", L"InstallAttack");
